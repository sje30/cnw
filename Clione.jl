...
Weights = repmat(WTS, Total_Neurons,1)
...
rkIndex = [1 1 2 3];
Stim1 = 0.5#input('Stimulating current strength, neuron 1 (red) (0-2): ');
Stim2 = 0;
ES = 9 ## input('Inhibitory synaptic conductance factor (0-320): ');
